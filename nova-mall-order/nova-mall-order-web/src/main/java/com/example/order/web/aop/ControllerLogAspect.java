package com.example.order.web.aop;
...
public class ControllerLogAspect {
    ...
    @Around("within(com.example.order.web.controller..*)")
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            sw.stop();
            log.info("{}", toJson("order", handler, httpMethod, uri, traceId, userId, clientIp, args, sw.getTotalTimeMillis(), null));
            return result;
        } catch (Throwable t) {
            sw.stop();
            log.error("{}", toJson("order", handler, httpMethod, uri, traceId, userId, clientIp, args, sw.getTotalTimeMillis(), t), t);
            throw t;
        }
    }
